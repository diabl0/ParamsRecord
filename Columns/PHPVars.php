 ...
 *
 */
namespace Piwik\Plugins\ParamsRecord\Columns;
...
class PHPVars extends ActionDimension
{
    ...
    {
        return Piwik::translate('ParamsRecord_PHPVars');
    }
    ...
    protected function configureSegments()
    {
        ...
        $segment->setName('ParamsRecord_PHPVars');
